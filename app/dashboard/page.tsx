...
export default function Page() {
  ...
  const [espInput, setEspInput] = useState<string>('https://www.youtube.com/watch?v=gLGqC7KMLgc');
  ...
  const [ytInput, setYtInput] = useState<string>('https://www.youtube.com/watch?v=gLGqC7KMLgc');
