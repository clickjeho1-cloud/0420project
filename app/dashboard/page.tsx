...
export default function Page() {
  ...
  const [espUrl, setEspUrl] = useState<string>('https://youtu.be/nmFpUDosSPc');
  const [espInput, setEspInput] = useState<string>('https://youtube.com/shorts/kB0nYgNU_ZI?feature=share');
